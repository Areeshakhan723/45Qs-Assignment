...
// If it has, print a message that the person will need to enter a new username. If
// a username has not been used, print a message saying that the username is available.

// • Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' 
// should not be accepted.

let current_users: string[] = ["Aliza", "Waniya", "Areeba", "Alina", "daniya"];

let new_users: string[] = ["Aliza", "Fatima", "Ali", "Alina", "daniya"];
